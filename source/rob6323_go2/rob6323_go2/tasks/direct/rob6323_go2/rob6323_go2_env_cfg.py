...
class Rob6323Go2EnvCfg(DirectRLEnvCfg):
    ...
    #Extra credit
    # actuator friction model (randomized per episode) ---
    enable_friction_model = True

    # Randomization ranges (per env episode)
    mu_v_range = (0.0, 0.3)   # viscous coefficient
    Fs_range   = (0.0, 2.5)   # stiction coefficient

    # tanh smoothing denominator from the spec: tanh(qdot / 0.1)
    stiction_smoothing = 0.1
# Copyright (c) 2022-2025, The Isaac Lab Project Developers (https://github.com/isaac-sim/IsaacLab/blob/main/CONTRIBUTORS.md).
# All rights reserved.
#
# SPDX-License-Identifier: BSD-3-Clause
